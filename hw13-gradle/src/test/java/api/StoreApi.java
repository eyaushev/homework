    ...
    */
    ...
    public class DeleteOrderOper {
        ...
        public <T> T execute(Function<Response, T> handler) {
            return handler.apply(RestAssured.given().spec(reqSpec.build()).expect().spec(respSpec.build()).when().request(DELETE, properties.getValue("store.getOrder")));
        }
    ...
    public class GetInventoryOper {
         ...
         */
        public <T> T execute(Function<Response, T> handler) {
            return handler.apply(RestAssured.given().spec(reqSpec.build()).expect().spec(respSpec.build()).when().request(GET, properties.getValue("store.getInventory")));
        }
    ...
    public class GetOrderByIdOper {
         ...
         */
        public <T> T execute(Function<Response, T> handler) {
            return handler.apply(RestAssured.given().spec(reqSpec.build()).expect().spec(respSpec.build()).when().request(GET, properties.getValue("store.getOrder")));
        }
    ...
    public class PlaceOrderOper {
        ...
        public <T> T execute(Function<Response, T> handler) {
            ...
            return handler.apply(RestAssured.given().spec(reqSpec.build()).expect().spec(respSpec.build()).when().request(POST, properties.getValue("store.placeOrder")));
        }
